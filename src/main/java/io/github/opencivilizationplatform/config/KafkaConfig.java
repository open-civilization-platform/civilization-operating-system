...
public class KafkaConfig {
    ...
    public static final String TOPIC_NEXUS_MESSAGE_SENT = "civos.nexus.message_sent";
    ...
    @Bean
    public NewTopic nexusMessageSentTopic() {
        return TopicBuilder.name(TOPIC_NEXUS_MESSAGE_SENT)
            .partitions(3)
            .replicas(1)
            .build();
    }
